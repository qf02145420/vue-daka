    ...
    children: [
      {
        path: "/homePage",
        name: "homePage",
        component: () => import("@/xiaodaka/homePage/index"),
        meta: {
          title: "首页",
          icon: "home",
          affix: true,
    ...
    children: [
      {
        path: "classList",
        name: "ClassList",
        component: () => import("@/xiaodaka/school/classList"),
        meta: {
          title: "我的班级",
          icon: "marker",
    ...
    children: [
      {
        path: "importData",
        name: "ImportData",
        component: () => import("@/xiaodaka/school/importStudentData"),
      },
    ],
  },
  {
        ...
        children: [
          {
            ...
            children: [
              {
                path: "menu1-1-1",
                component: () => import("@/views/byui/nested/menu1/menu1-1/menu1-1-1/index"),
                name: "Menu1-1-1",
