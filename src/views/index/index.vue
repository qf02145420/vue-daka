    ...
    <el-row :gutter="15">
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="6" :xl="6">
        <el-card shadow="never">
          ...
          <byui-chart :autoresize="true" theme="byui-echarts-theme" :options="fwl" />
          <div class="bottom">
            <span
              >日均访问量:
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="6" :xl="6">
        <el-card shadow="never">
          ...
          <byui-chart :autoresize="true" theme="byui-echarts-theme" :options="sqs" />
          <div class="bottom">
            <span
              >总授权数:
              <byui-count
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="16" :xl="16">
        <el-card class="card" shadow="never">
          ...
          <byui-chart :autoresize="true" theme="byui-echarts-theme" :options="xsl" />
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
        <el-card class="card" shadow="never">
          ...
          <div class="bottom-btn">
            ...
            <a target="_blank" href="https://github.com/chuzhixin/vue-element-admin-beautiful">
      ...
      <el-col :span="24">
        <el-alert title="beautiful boys and girls欢迎加入vue-admin-beautifulQQ群：972435319" :closable="false">
        </el-alert>
        <br />
      </el-col>
      <el-col v-for="(item, index) in iconList" :key="index" :xs="12" :sm="6" :md="3" :lg="3" :xl="3">
        <app-link :to="item.link" target="_blank">
          <el-card class="icon-panel" shadow="never">
            <byui-icon :style="{ color: item.color }" :icon="['fas', item.icon]"></byui-icon>
            <p>{{ item.title }}</p>
          </el-card>
        </app-link>
      </el-col>
